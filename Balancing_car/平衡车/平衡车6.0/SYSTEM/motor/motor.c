...
void motorA(int g)
{
	switch(g)
	{
		...
		case 2:GPIO_SetBits(GPIOB,GPIO_Pin_13);GPIO_ResetBits(GPIOB,GPIO_Pin_12);break;
	}
}
void motorB(int g)
{
	switch(g)
	{
		...
		case 2:GPIO_SetBits(GPIOB,GPIO_Pin_14);GPIO_ResetBits(GPIOB,GPIO_Pin_15);break;
	}
}
void speed_A(int g)
{
