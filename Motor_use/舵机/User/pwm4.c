...
void TIM4_PWM_Init(u16 arr,u16 psc){
    ...
    GPIO_InitStrue.GPIO_Pin=GPIO_Pin_TIM4_Def|GPIO_Pin_8;  //Pin
    ...
    TIM_OC3Init(TIM4_Def,&TIM_OCInitStrue);  //TIM_CH
    
    TIM_OC3PreloadConfig(TIM4_Def,TIM_OCPreload_Enable); //TIM_CH
