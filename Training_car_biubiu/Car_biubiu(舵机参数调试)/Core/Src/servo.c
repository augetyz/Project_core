...
void servo_Ctrl(servo_status servo)
{
    ...
    angle[0] = (servo.value_goal[0] - PWM1) / 256;
    angle[1] = (servo.value_goal[1] - PWM2) / 256;
    angle[2] = (servo.value_goal[2] - PWM3) / 256;
    angle[3] = (servo.value_goal[3] - PWM4) / 256;
    angle[4] = (servo.value_goal[4] - PWM5) / 256;
    angle[5] = (servo.value_goal[5] - PWM6) / 256;
